...
texts = ["This is a list with my documents I want to translate. I can pass complete documents for translation.",
         ...
         # I can even mix the languages I pass to the translation API.
         "Incluso puedo mezclar los idiomas que paso a la API de traducción."
         ]
...
for text in texts:
    r = requests.get(url+"/translate?target_lang=" +
                     target_lang+"&text="+quote(text))
...
r = requests.post(url+"/translate",
                  json={'target_lang': target_lang, 'text': texts})
...
texts = ["Dies ist ein deutscher Satz",
         "This is an English sentence", "这是一个中文句子"]
for text in texts:
